...
public class ItemController {
    ...
    public String itemDetail(@PathVariable("itemId") Long itemId,
        ...
        try{
            ...
            model.addAttribute("errarMessage","존재하지 않는 상품입니다.");
    ...
    public String itemDetail(@Valid ItemFormDto itemFormDto, BindingResult bindingResult, Model model
    ...
    , @RequestParam("itemImgFile")List<MultipartFile> itemImgFileList){
        ...
        try {
            ...
            model.addAttribute("errorMessage","상품 등록 실패. 다시 시도해주세요.");
            return "item/itemForm";
        }
